...
public class Transactions extends JFrame implements ActionListener{
    ...
    Transactions(){
        ...
        l1 = new JLabel("Please Select Your Transaction",JLabel.CENTER);
        ...
        l1.setBounds(110,50,537,40);
        getContentPane().add(l1);
        
        b1.setBounds(40,115,300,60);
        getContentPane().add(b1);
        
        b2.setBounds(440,115,300,60);
        getContentPane().add(b2);
        
        b3.setBounds(40,225,300,60);
        getContentPane().add(b3);
        
        b4.setBounds(440,225,300,60);
        getContentPane().add(b4);
        
        b5.setBounds(40,335,300,60);
        getContentPane().add(b5);
        
        b6.setBounds(440,335,300,60);
        getContentPane().add(b6);
        
        b7.setBounds(240,445,300,60);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){ 
            ...
            Conn c1 = new Conn();
            try {
            ResultSet rs = c1.s.executeQuery(" SELECT balance FROM bank where pin = '"+pinn+"' ORDER BY id DESC LIMIT 1");
                if(rs.next()){
